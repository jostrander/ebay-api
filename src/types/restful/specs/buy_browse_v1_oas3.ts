...
export interface components {
    schemas: {
        ...
        CoreItem: {
            ...
            charityTerms?: components["schemas"]["ItemCharityTerms"];
...
export interface operations {
    ...
    getItemByLegacyId: {
        parameters: {
            query: {
                /** @description This field controls what is returned in the response. If this field is not set, the method returns all details about the item. Multiple <code>fieldgroups</code> can be set.<br><br><b>Valid Values:</b><ul><li> <b>PRODUCT</b><br>This field group adds the <a href="/api-docs/buy/browse/resources/item/methods/getItemByLegacyId#response.product">product</a> container to the response. </li><li><b>ADDITIONAL_SELLER_DETAILS</b><br>This field group adds the <a href="/api-docs/buy/browse/resources/item/methods/getItemByLegacyId#response.seller.userId">userId</a> field to the response.</li><li><b>CHARITY_DETAILS</b><br>This field group adds the the <a href="/api-docs/buy/browse/resources/item/methods/getItemByLegacyId#response.charityTerms">charityTerms</a> container to the response, if applicable.</li></ul> */
                fieldgroups?: string;
